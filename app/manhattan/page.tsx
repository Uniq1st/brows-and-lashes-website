...
export const metadata: Metadata = {
  title: "Eyebrow Threading Upper East Side | #1 on Google Maps | Brows & Lashes by UniqSwek",
  description:
    "Ranked #1 beauty salon on Google Maps — Upper East Side Manhattan. Expert eyebrow threading & lash extensions at 1240 Lexington Ave. 200+ five-star reviews. Walk-ins welcome.",
...
const uesTeam = [
  ...
  { name: "Gita",                                   role: "Licensed Technician",                  initials: "GI", color: "bg-emerald-100 text-emerald-700", ring: "ring-emerald-200", photo: null },
]
